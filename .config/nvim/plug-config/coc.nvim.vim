...
" NOTE: THIS IS FOR GOING UP AND DOWN IN THE SUGGESTIVE MENU
...
" THIS IS FOR ACCEPTING THE SOLUTION, WHICH IS ENTER
...
xmap <leader>x  <Plug>(coc-convert-snippet)map <C-l> <Plug>(coc-snippets-expand)
